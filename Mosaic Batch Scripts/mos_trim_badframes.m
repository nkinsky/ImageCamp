...
badframe_movie = mosaic.loadMiniscope(movie_path,'loadingOption','stream',...
...
% Minimum Projection
min_proj_int = mosaic.projectMovie(CatMovie_goodframes,'projectionType','Minimum');
h = mos_tiff_to_fig(CatMovie_goodframes, [pathname 'TrimCatMovie_min_proj.tiff'], ...
