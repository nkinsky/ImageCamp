...
min_proj_int = mosaic.projectMovie(mot_corr_movie,'Minimum');
...
ICmovie = mosaic.cropMovie(movie_corr_movie, rect_crop_mos(1). rect_crop_mos(2), ...
    rect_crop_mos(3), rect_crop_mos(4)); % Crop movie


%% Step 8: Create min projection and display

min_proj = mosaic.projectMovie(ICmovie,'Minimum');
