...
dvt_file = importdata('C:\Users\kinsky.AD\Documents\Lab\Imaging\Fear Conditioning Pilot\Control Group\Day0\FC103312014001_FCcontext_habituation.DVT'); % 2014JAN27_S04_square.dvt
...
[ pix_x pix_y x_matrix y_matrix ] = pixel_time_spike_bin( Xcm, Ycm, npix_x, npix_y, frame_rate );
...
motion_thresh = 0.6; % Motion threshold for freezing...
...
total_freeze_time_k = sum(freeze_time_k_diff(freeze_time_k_diff < 1.05/frame_rate));
