...
<html class="   ">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# object: http://ogp.me/ns/object# article: http://ogp.me/ns/article# profile: http://ogp.me/ns/profile#">
    ...
    <title>oopsi/z1.m at master · jovo/oopsi · GitHub</title>
...
<meta content="GitHub" property="og:site_name" /><meta content="object" property="og:type" /><meta content="https://avatars1.githubusercontent.com/u/41842?s=400" property="og:image" /><meta content="jovo/oopsi" property="og:title" /><meta content="https://github.com/jovo/oopsi" property="og:url" /><meta content="oopsi - up-to-date code for model-based inference of spike trains from calcium imaging" property="og:description" />
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="80C551D4:4762:4F5B710:5395B508" name="octolytics-dimension-request_id" />
...
<meta content="PqMcwX6A6kIWFC1rZCdXkkg3MNw3EALDOxVplGpTQ0Sh5cT2BC4qPM+l8hxOte+h9ZwStKmLa+0yHxQFhYhMDA==" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fjovo%2Foopsi%2Fblob%2Fmaster%2Fz1.m">Sign in</a>
    </div>
...
<a href="/jovo/oopsi/blob/d1931c4faf33728e400112c6516770f530418200/z1.m" class="hidden js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:c52100df3abab8811e5e0704d6fc63d8 -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/jovo/oopsi/blob/gh-pages/z1.m"
                 data-name="gh-pages"
                 data-skip-pjax="true"
                 rel="nofollow"
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/jovo/oopsi/blob/master/z1.m"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item ">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/jovo/oopsi/tree/v1.0/z1.m"
                 data-name="v1.0"
                 data-skip-pjax="true"
                 rel="nofollow"
                 class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target"
    ...
    <div class="meta clearfix">
      ...
      <div class="actions">
        <div class="button-group">
          ...
          <a href="/jovo/oopsi/raw/master/z1.m" class="button minibutton " id="raw-url">Raw</a>
            <a href="/jovo/oopsi/blame/master/z1.m" class="button minibutton js-update-url-with-hash">Blame</a>
          <a href="/jovo/oopsi/commits/master/z1.m" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L11" rel="#L11">11</span>
           ...
           <td class="blob-line-code"><div class="code-body highlight"><pre><div class='line' id='LC1'><span class="k">function</span><span class="w"> </span>x <span class="p">=</span><span class="w"> </span><span class="nf">z1</span><span class="p">(</span>y<span class="p">)</span><span class="w"></span></div><div class='line' id='LC2'><span class="c">% linear normalize between 0 and 1</span></div><div class='line' id='LC3'><span class="n">x</span> <span class="p">=</span> <span class="p">(</span><span class="n">y</span><span class="o">-</span><span class="n">min</span><span class="p">(</span><span class="n">y</span><span class="p">(:)))</span><span class="o">/</span><span class="p">(</span><span class="n">max</span><span class="p">(</span><span class="n">y</span><span class="p">(:))</span><span class="o">-</span><span class="n">min</span><span class="p">(</span><span class="n">y</span><span class="p">(:)))</span><span class="o">+</span><span class="nb">eps</span><span class="p">;</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="c">% for multidimensional stuff, this normalizes each column to between 0 and</span></div><div class='line' id='LC6'><span class="c">% 1 independent of other columns</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><span class="c">% T=length(y);</span></div><div class='line' id='LC9'><span class="c">% y=y&#39;;</span></div><div class='line' id='LC10'><span class="c">% miny=min(y);</span></div><div class='line' id='LC11'><span class="c">% x = (y-repmat(miny,T,1))./repmat(max(y)-min(y),T,1);</span></div></pre></div></td>
         </tr>
       </table>
  </div>
