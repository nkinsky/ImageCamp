function [cell_map_reg cell_map_header_reg ] = image_register(base_file, register_file, rotation) % , cell_map, cell_map_header)
...
regtype = 'affine'; % Similarity = Translation, Rotation, Skewing
