...
if nargin == 1
   MinThreshPixels = input('Please enter a number for MinThreshPixels: ');
end
try
    ...
    while (toContinue ~= 0)
        ...
        while (Curr <= NumICA)
            ...
            % NK Edit - is there any way to not have x and y pixel values
            % on the plots? They are confusing visually
            Curr = Curr+1;
            WinCurr = WinCurr +1;
        end
    ...
    save('ICAoutlines.mat','IC','ICThresh','x','y','NumICA','-v7.3')
