...
% Note that this may require some adjusting to get back to T2 - I started
% updating through here before I realized that it might be smart to leave a
% legacy T2 version around...
