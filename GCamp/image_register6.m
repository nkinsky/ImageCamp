function [cell_map_reg, cell_map_header_reg ] = image_register6(base_file, register_file, cell_merge) % , cell_map, cell_map_header)
...
overlap_auto_same = 0.7; % any cells with more than this overlap will 
% automatically be counted as the same cell, unless there are two cells
% with this much overlap or more.
overlap_auto_new = 0.7; % any cells with less than this overlap will 
% automatically be counted as a new cell
...
save([base_path 'CellRegisterInfo.mat'], 'CellRegisterInfo','-v7.3')
