function [hout, hmean_shuf, hmean_CI, unique_lags, mean_corr_cell] = plot_PVcurve(PV_corrs, lag, varargin)
...
ip.addParameter('hin', nan, @ishandle);
...
if ~ishandle(hin); figure; hin = gca; end
