function [ categories ] = alt_parse_cell_category( sesh, pval_thresh,...
    ntrans_thresh, PFname )
% categories = alt_parse_cell_category( sesh, pval_thresh, ntrans_thresh,... )
%
...
[pctemp, ntrans_pass] = pf_filter(sesh, pval_thresh, ntrans_thresh, ...
    PFname);
categories(stem_cells & cellfun(@any,sigcurve) & ntrans_pass) = 1; % Should this also have to be a "place cell"
