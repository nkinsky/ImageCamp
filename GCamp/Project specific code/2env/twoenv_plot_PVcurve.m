function [ hout, unique_lags, mean_corr_cell, hmean_CI , CI, day_lag, mean_shuf_cell] = ...
    twoenv_plot_PVcurve( PV_corrs, sesh_type, PV_corrs_shuffle, hin, ...
    plot_curves, filter, dont_plot )
% [ hout, unique_lags, mean_corr_cell, hmean_CI , CI, day_lag, mean_shuf_cell] = ...
%     twoenv_plot_PVcurve( PV_corrs, sesh_type, PV_corrs_shuffle, hin, ...
%     plot_curves, filter, dont_plot )
%
...
%% Plot it
[hout, ~, hmean_CI, unique_lags, mean_corr_cell, CI, ~, mean_shuf_cell] = ...
    plot_PVcurve(PV_corrs, day_lag, 'PV_corrs_shuffle', PV_corrs_shuffle,...
