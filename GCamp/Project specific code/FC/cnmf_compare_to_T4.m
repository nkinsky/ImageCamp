...
% Script - make this a function? Not needed yet

clear all
dir_use = 'e:\Eraser\Marble7\CNMFtesting'; % 'e:\CNMF_E demos';
cnmf_filename = '06-Apr_14_24_44.mat'; %'data_1p_results.mat';
SR = 10;
...
load(cnmf_filename,'results','neuron')

% Make variable names nicer
if ~exist('results','var') && exist('neuron','var')
    results = neuron;
end
ROI_T4 = NeuronImage;
...
%%
figure(25); 
h(1) = subplot(3,2,1); hold off; 
h(2) = subplot(3,2,2); hold off; 
h(3) = subplot(3,2,3:4); hold off;
h(4) = subplot(3,2,5:6); hold off;
...
while stay_in
    ...
    subplot(h(2));
    plot_neuron_outlines(results.Cn,ROI_T4{n_out},h(2));
